...
//
// Real capture, unmodified (axlehqcore-1). Two long-description neighbors
// followed by one short-description neighbor, to catch the fix under- or
...
Neighbor Chassis-ID            : 38:10:f0:cf:64:00
Neighbor Management-Address    : 10.237.0.46
...
Neighbor System-Description    : Aruba JL357A 2540-48G-PoE+-4SFP+ Switch, revision YC.16.10.0024, ROM YC.16.01.0002 (/ws/swbuildm/rel_ajanta_qaoff/code/build/cpm(swbuildm_rel_ajanta_qaoff_rel_ajanta))
Neighbor Chassis-ID            : 10:4f:58:ee:c3:80
Neighbor Management-Address    : 10.237.0.33
Chassis Capabilities Available : Bridge, Router
Chassis Capabilities Enabled   : Bridge
Neighbor Port-ID               : 49
Neighbor Port-Desc             : 49
...
Neighbor Entries Dropped       : 0
Neighbor Entries Aged-Out      : 2
Neighbor System-Name           : AXLE-SCALE-SS01
Neighbor System-Description    : Aruba R8S92A  FL.10.10.1090
Neighbor Chassis-ID            : d4:e0:53:9c:02:80
Neighbor Management-Address    : 10.237.0.21
Chassis Capabilities Available : Bridge, Router
