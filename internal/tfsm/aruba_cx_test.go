...
Neighbor Chassis-ID            : 00:11:22:aa:bb:01
...
Neighbor System-Description    : Aruba JL357A 2540-48G-PoE+-4SFP+ Switch, revision YC.16.10.0024, ROM YC.16.01.0002 (/ws/swbuildm/rel_ajanta_qaoff/code/build/cpm(swbuildm_rel_ajanta_qaoff_rel_ajanta))
Neighbor Chassis-ID            : 00:11:22:aa:bb:02
...
// name is genericized from the real capture; the multi-line description
// text is reproduced verbatim since it is the exact shape that broke
// the parser.
...
Neighbor Chassis-ID            : 00:11:22:aa:bb:03
...
Neighbor Chassis-ID            : 00:11:22:aa:bb:04
...
func TestArubaCXParsesPastMultilineDescription(t *testing.T) {
	...
	if recs[0]["CHASSIS_ID"] != "00:11:22:aa:bb:03" {
		t.Errorf("recs[0] CHASSIS_ID = %q, want %q", recs[0]["CHASSIS_ID"], "00:11:22:aa:bb:03")
	}
