...
Search greps every captured configuration in a store. It answers "where is this
configured" across an entire estate, from files already on your disk, in
milliseconds — no device is contacted.
